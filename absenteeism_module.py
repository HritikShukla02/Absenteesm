...
class absenteeism_model():
        ...
        def load_and_clean_data(self, data_file):
            ...
            # re-order the columns in df
            column_names_upd = ['Reason_1', 'Reason_2', 'Reason_3', 'Reason_4', 'Month', 'Weekday',
            ...
            self.data = self.scaler.transform(df[['Weekday',
                                'Transportation Expense', 'Age',
                                'Body Mass Index', 'Children',
                                'Pets']])
            temp_data = pd.DataFrame(columns=['Weekday',
                                'Transportation Expense', 'Age',
                                'Body Mass Index', 'Children',
                                'Pets'], data=self.data)
            self.data = pd.concat([df[['Reason_1', 'Reason_2', 'Reason_3', 'Reason_4']], temp_data, df['Education']], axis=1)
